...
class AlphaBetaPlayer(IsolationPlayer):
    ...
    def alphabeta(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        ...
        **********************************************************************
        ...
        return self.minmaxCalculation(game, depth)[0]        

    def minmaxCalculation(self, game, depth, alpha=float("-inf"), beta=float("inf")):
        """
        ...
        value, func, best_move, is_alpha = None, None, (-1, -1), False
        ...
        for move in game.get_legal_moves():
            ...
            score = self.minmaxCalculation(next_ply, depth - 1, alpha, beta)[1]
       
            if score == func(value, score) and score != value:
                value = score
                best_move = move
            if is_alpha:
                if value >= beta:
